...
file_path_cdf_x = result_folder_path + dataset_name + "-CDF_points_x.csv"
file_path_cdf_y = result_folder_path + dataset_name + "-CDF_points_y.csv"
...
result_file_path = result_folder_path + dataset_name + "_copula_data.xlsx"
