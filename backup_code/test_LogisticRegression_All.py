...
def logistic_regress_on_original_data(folder_name, file_name):
    ...
    with open("./" + folder_name + "/regression_result_" + file_name + "_origin.txt", 'a') as opened_file:
        ...
        # 筛选特征值和目标值
        x_undersample = raw_data_undersample.loc[:, ["mean", "Standard_Deviation", "Skewness","Kurtosis"]]
...
def logistic_regress_on_normalised_data(folder_name, file_name):
    ...
    with open("./" + folder_name + "/regression_result_" + file_name + "_normalised.txt", 'a') as opened_file:
        ...
        # 筛选特征值和目标值
        x_undersample = raw_data_undersample.loc[:, ["mean_normalised", "Standard_Deviation_normalised", "Skewness","Kurtosis"]]
        y_undersample = raw_data_undersample["label"]
...
# folder_name = "logistic_regression_data"


# file_name = "annthyroid_statistic_data"

# file_name = "cardio_statistic_data"

# file_name = "mnist_statistic_data"

# file_name = "satellite_statistic_data"

# file_name = "shuttle_statistic_data"

file_name = "thyroid_statistic_data"
