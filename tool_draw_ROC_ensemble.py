...
for dataset_name in dataset_names:
    ...
    fig, (ax_e, ax_s, ax_ensemble_score) = plt.subplots(ncols=3, nrows=1, figsize=(30, 10))
    for dataset_type in dataset_types:
        ...
        ax_ensemble_score.plot(fpr_ensemble_score, tpr_ensemble_score, label=dataset_type, color=plot_color, linestyle=plot_linestyle)
    ...
    # ax_s.set_ylabel('TPR')
    ax_ensemble_score.set_title("SIF_EIF_ensemble_score ROC Curve")
